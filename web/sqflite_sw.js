...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    WasmBindings$_(instance, callbacks) {
      ...
      var $async$WasmBindings_instantiateAsync = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              injectedDartFunctions = new A.DartBridgeCallbacks(A.LinkedHashMap_LinkedHashMap$_empty(type$.int, type$.AggregateContext_nullable_Object));
              _this = {};
              _this.dart = new A.WasmBindings_instantiateAsync_closure(injectedDartFunctions).call$0();
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.WasmInstance_load(response, _this), $async$WasmBindings_instantiateAsync);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.WasmBindings$_($async$result, injectedDartFunctions);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    WasmBindings$__closure: function WasmBindings$__closure(t0) {
      this.$this = t0;
    },
    WasmBindings$__closure0: function WasmBindings$__closure0(t0) {
      this.$this = t0;
    },
    WasmBindings$__closure1: function WasmBindings$__closure1(t0) {
      this.$this = t0;
    },
    WasmBindings$__closure2: function WasmBindings$__closure2(t0) {
      this.$this = t0;
    },
    WasmBindings_instantiateAsync_closure: function WasmBindings_instantiateAsync_closure(t0) {
      this.injectedDartFunctions = t0;
    },
    ...
    WasmInstance_load(response, imports) {
      var $async$goto = 0,
        ...
        $async$returnValue, native, exports;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(init.G.WebAssembly.instantiateStreaming(response, imports)), type$.JSObject), $async$WasmInstance_load);
            case 3:
              // returning from await.
              native = $async$result;
  ...
  A.WasmBindings.prototype = {
    WasmBindings$_$2(instance, callbacks) {
      var _this = this,
        t1 = _this.callbacks;
      t1.__DartBridgeCallbacks_bindings_F !== $ && A.throwLateFieldAI("bindings");
      t1.__DartBridgeCallbacks_bindings_F = _this;
      t1 = type$.int;
      A._FinalizationRegistryWrapper$(new A.WasmBindings$__closure(_this), t1);
      A._FinalizationRegistryWrapper$(new A.WasmBindings$__closure0(_this), t1);
      _this.databaseFinalizer = A._FinalizationRegistryWrapper$(new A.WasmBindings$__closure1(_this), t1);
      _this.statementFinalizer = A._FinalizationRegistryWrapper$(new A.WasmBindings$__closure2(_this), t1);
    },
